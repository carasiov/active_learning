...
from rcmvae.utils import get_device_info

from .base import HistoryDict, MetricsDict, TrainingCallback
...
class ConsoleLogger(TrainingCallback):
    ...
    def on_train_start(self, trainer: "Trainer") -> None:
        ...
        # Device info is surfaced in the experiment header; keep quiet here.
