...
class VampPrior:
    ...
    def compute_kl_terms(
        ...
        if encoder_output.extras is None:
            raise ValueError("VampPrior requires extras with pseudo-input statistics")
    ...
    def compute_reconstruction_loss(
        ...
        Note:
            VampPrior always uses standard (non-weighted) reconstruction
            because it doesn't use component-aware decoder. The spatial
