...
- Structure references: `docs/STRUCTURE.md`
- Cleanup notes: `docs/CLEANUP_NOTES.md`
- Mission documentation: `ROOT/refactor_spec_part1.txt`, `ROOT/refactor_spec_part2.txt`, `ROOT/progress_tracker.txt`

If you plan to extend the system, ensure new features surface through config where possible, keep dependencies minimal, and update the progress tracker and showcase notebook when significant capabilities are added.
...
If a license applies, add it here. Otherwise, coordinate access terms with the project owner or supervisor.
